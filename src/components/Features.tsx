const features = [
  ...
  },
  {
    ...
    description:
      'Comprehensive instrument catalog with metadata, identifiers, and ' +
      'cross-references across multiple data providers.',
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map(feature => (
            <div key={feature.title} className="glass-card group transition-colors hover:border-ocean-500/30">
              <div className="mb-4 inline-flex rounded-lg bg-ocean-600/20 p-3 text-ocean-400">
                {feature.icon}
              </div>
